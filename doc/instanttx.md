...
This mechanism has been integrated into Bitcore-Node-SafeInsure which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/SafeInsure-Project/insight-api-safeinsure#web-socket-api](https://github.com/SafeInsure-Project/insight-api-safeinsure#web-socket-api) 
* API: [https://github.com/SafeInsure-Project/insight-api-safeinsure#instantsend-transactions](https://github.com/SafeInsure-Project/insight-api-safeinsure#instantsend-transactions) 
...
By default, the SafeInsure Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SafeInsure Core daemon:
