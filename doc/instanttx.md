...
This mechanism has been integrated into Bitcore-Node-Dashlite which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Dashlite-Project/insight-api-Dashlite#web-socket-api](https://github.com/Dashlite-Project/insight-api-Dashlite#web-socket-api) 
* API: [https://github.com/Dashlite-Project/insight-api-Dashlite#instantsend-transactions](https://github.com/Dashlite-Project/insight-api-Dashlite#instantsend-transactions) 
...
By default, the Dashlite Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Dashlite Core daemon:
