...
In order to support loading of multiple wallets in Dashlite-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Dashlite.cpp.
...
Changes to Dashlite.cpp
----------------------
Dashlite.cpp is the entry point into Dashlite-qt, and as such, will require some minor modifications to provide hooks for
