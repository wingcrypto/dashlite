...
In order to support loading of multiple wallets in safeinsure-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is safeinsure.cpp.
...
Changes to safeinsure.cpp
----------------------
safeinsure.cpp is the entry point into safeinsure-qt, and as such, will require some minor modifications to provide hooks for
