Contributing to SafeInsure Core
============================

The SafeInsure Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SafeInsure Core project, and is not to be
confused with overall SafeInsure Network Protocol consensus changes.

Whether a pull request is merged into SafeInsure Core rests with the project merge
...
Patches that change SafeInsure consensus rules are considerably more involved than
...
Where a patch set proposes to change the SafeInsure consensus, it must have been
...
The project leader is the release manager for each SafeInsure Core release.
