Contributing to Dashlite Core
============================

The Dashlite Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Dashlite Core project, and is not to be
confused with overall Dashlite Network Protocol consensus changes.

Whether a pull request is merged into Dashlite Core rests with the project merge
...
Patches that change Dashlite consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dashlite consensus, it must have been
...
The project leader is the release manager for each Dashlite Core release.
