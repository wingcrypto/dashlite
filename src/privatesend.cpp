    ...
    if (fMasterNode) {
        ...
        BOOST_FOREACH (const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Dashlite and make it unusable. To
...
bool CPrivatesendPool::DoAutomaticDenominating(bool fDryRun)
{
    ...
    CAmount nBalanceNeedsAnonymized = nAnonymizeDashliteAmount * COIN - pwalletMain->GetAnonymizedBalance();
...
void ThreadCheckPrivateSendPool()
{
    ...
    RenameThread("Dashlite-privatesend");
