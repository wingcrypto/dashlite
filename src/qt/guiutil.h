...
/** Utility functions used by the Dashlite Qt UI.
 */
namespace GUIUtil
{
...
// Render Dashlite addresses in monospace font
...
// Parse "Dashlite:" URI into recipient object, return true on successful parsing
