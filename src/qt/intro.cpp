...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Dashlite Core"),
     ...
     * override -datadir in the Dashlite.conf file in the default data directory
     * (to be consistent with Dashlited behavior)
     */
    if (dataDir != getDefaultDataDirectory())
